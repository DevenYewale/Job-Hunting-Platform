...
class ProfileDB {
    ...
    public function delete($id){
		$sqlQ = "DELETE FROM {$this->dbTable} WHERE Profile_id =?"; 
		$stmt = $this->db->prepare($sqlQ);
    ...
    public function isProfileExists($title, $id=''){
        $sqlQ = "SELECT * FROM {$this->dbTable} WHERE LOWER(Profile_Title)=?";
        if(!empty($id)){
            $sqlQ .= " AND Profile_id  != ?";
        }
        $stmt = $this->db->prepare($sqlQ);
    ...
    public function GetProfileList($JobhunterID){
        $sqlQ = "SELECT Profile_id, Profile_Title FROM {$this->dbTable} WHERE LOWER(JobHunter_ID)=". $JobhunterID;
