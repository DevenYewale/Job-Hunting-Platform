...
class EmployerDb {
    ...
    public function delete($id){
		$sqlQ = "DELETE FROM {$this->dbTable} WHERE Company_ID=?"; 
		$stmt = $this->db->prepare($sqlQ);
    ...
    public function EmployerLogin($EMail, $Password){
        $sqlQ = "SELECT * FROM `{$this->dbTable}` WHERE LOWER(`Email`) = '" . $EMail . "' and `Password` = '" . $Password .  "'" ;
        $stmt = $this->db->prepare($sqlQ);
        $stmt->execute();
        $result = $stmt->get_result();
    ...
    public function GetEmployerID($EMail){
        $sqlQ = "SELECT Company_ID, CompanyName FROM `{$this->dbTable}` WHERE LOWER(`Email`) = '" . $EMail . "'" ;
        $stmt = $this->db->prepare($sqlQ);
        $stmt->execute();
        $result = $stmt->get_result();
